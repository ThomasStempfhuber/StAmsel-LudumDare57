...
Talk to the townsfolk and unravel the mystery surrounding the **Pfarrer (Pastor)**.

<img width="724" height="701" alt="Capture" src="https://github.com/user-attachments/assets/31f4c590-44ea-4c2b-974d-66d85c538b3a" />
...
My goal for this jam was to create a **narrative-driven** game.  
I originally planned to include puzzles and exploration, but due to time constraints, the focus is now **entirely on dialogue and story**.

<img width="1054" height="610" alt="Capture2" src="https://github.com/user-attachments/assets/971f2184-569e-4999-aba1-736f4d19f78e" />

---

## 🧰 Tools & Software Used

- ⛪ **Engine:** Godot, Dialogue Manager by **@nathanhoad**  
- 🎨 **Graphics:** Aseprite, GIMP  
- 🎼 **Music:** LMMS, Audacity  
- 🎤 **Sounds:** Church bells and birds recorded this weekend in my village  
